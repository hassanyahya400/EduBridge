...
namespace EduBridge.API.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Colleges",
                columns: new[] { "Id", "Address", "City", "Name", "PermanentAddress", "ShortName" },
                values: new object[,]
                {
                    { 745262, "Acadip drive, cairo", "Iwo", "ACADIP University", null, "ACADIP" },
                    { 1091430, "Al-Madina Al-munawarah", "Al-madina", "Islamic College University", null, "ICU" }
                });
